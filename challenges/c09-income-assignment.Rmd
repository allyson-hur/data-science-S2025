...
-   Can you confidently distinguish between household incomes in Suffolk county? Why or why not?
    -   No because household incomes in Suffolk county overlap a lot, so one median income can fall into the range of multiple houses.
...
-   What *overall* trend do you see between `SE` and population? Why might this trend exist?
    -   There is a small negative correlation between standard error and population, though it's not a strong trend. If the Census Bureau collects data proportional to the population size, a larger population could lead to a larger sample size.
