...
- Higher carats seem to vary much more in terms of price compared to the
  lower carats (more outliers on the higher-carat side of the plot)
- There is not a lot of data on diamonds above two carats. More data
  should be collected to assess the strength of the positive
  correlation.
