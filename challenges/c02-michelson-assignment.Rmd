...
**Observations**: - Write your observations here! - Most images had a distinctness of 3, followed by 2, then 1. Distinctness 1 had considerably less images than the other two. - Why might your table differ from Michelson's?

The initial meanVelocity was rounded to the nearest tenth, so I casted it as an integer. The mean velocity slightly differs from Michelson's likely due to the rounding error. Perhaps a different rounding technique was used.
...
Michelson's estimate of the error is less than the true error. The difference betweeen Michelson's estimate and the actual value is 151.542, while Michelson estimated the plus minus bounds to be 51.
...
-   The means of both the real and simulated graphs stay close the same centerline at x = 299950.

-   Both graphs seem to reach very similar values for velocity at the end of June

-   The means of both graphs seem to stay within the bounds of 299900 m/s - 300000 m/s (with the exception of a few outliers)

Differences

-   There generally seem to be higher peaks and lower troughs in the real data graph, especially toward the beginning of June.

-   There seems to be more data points for the simulated graph compared to the real graph.

-   There's more variation in the mean toward the beginning of June for the real data, whereas there's more variation in the mean toward the end of June for the simulated data.
...
-   The lowest velocity in vacuum values tend to have low temperatures as well.
-   Distinctness levels 2 and 3 have more high temperature values compared level 1, though level 3 has the most high temperature values.
-   Most distinctness level 1 values were founded between June 13 and June 20, whereas level 2 and 3 are a lot more varied regarding the date the values were recorded.
-   There are higher temperatures toward the end of June. The lower temperatures during the middle of June correlate with the lower distinctness during the middle of June.
-   There is no particular pattern, but most values seem to be higher than LIGHTSPEED_VACUUM. Perhaps the measurement tool Michelson used or his procedure resulted in overall higher values.
