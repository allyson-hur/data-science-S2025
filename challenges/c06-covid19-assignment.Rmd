...
-   Top 10 counties for cases are Loving, Chattahoochee, Nome Census Aream Northwest Arctic Borough, Crowley, Bethel Census Area, Dewey Dimmit, Jim Hogg, and Kusilvak Census Area.
-   top_cases_per100k ranged from 49817 to 192156, while top_deaths_per100k ranged from 946 to 1359
-   The mean for top cases is 9974, while the mean for top deaths is 174
-   When did these "largest values" occur?
    -   The means for the top cases and deaths are significantly lower than the top 10, so the top 10 are likely outliers.
