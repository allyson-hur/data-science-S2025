...
- Are there any differences?
  - According to the Wikipedia page, there were around 2,224 passengers
    and crew aboard. There are 2,201 people accounted for in the
    dataset.
- If yes, what might account for those differences?
  - The 23 people that weren’t accounted for might’ve cancelled their
    trip before boarding the Titanic. Additionally, apparently some
    passengers traveled under aliases, and were therefore double-counted
    on the casualty lists. The dataset might’ve taken into account some
    of those aliases.
  - …
...
- Each class had more female survivors except for the crew. It’s unclear
  whether this is because there were more male crew than female crew on
  the ship.
- 2nd class had the least number of survivors, with the majority being
  female.
- Since we’re only looking at the survivors, it’s difficult to tell why
  2nd class had the least number of survivors. Perhaps that class was
  the smallest?
...
- Write your observations here.
  - A lot more females survived compared to males in both the 3rd and
    crew classes
  - 3rd class had the lowest proportion of survivors.
  - Everyone in 1st and 2nd class survived, both male and female.
- Is there anything *fishy* going on in your plot?
  - The plot suggests that essentially everyone in 1st and 2nd classes
    survived. This seems quite unreasonable and unlikely.
